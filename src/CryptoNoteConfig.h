...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(77777777);
...
const uint64_t MINIMUM_FEE                                   = 100007;
...
const char     CRYPTONOTE_NAME[]                             = "Good Deed Coin";
...
const int      P2P_DEFAULT_PORT                              = 17757;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 17776;
